...
HD_PWD='F:/vivado/peixun/final_pro/final_pro.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log final_pro.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source final_pro.tcl
